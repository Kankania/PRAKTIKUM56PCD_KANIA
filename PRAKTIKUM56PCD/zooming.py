...
image = img.imread('d:\\FOTO KANIA CANTIK\\WhatsApp Images\\WhatsApp Images\\kania.jpg')
skala = 2.0

imgZoom = zoomPlus(image, skala)
img.imwrite("d:\\FOTO KANIA CANTIK\\WhatsApp Images\\WhatsApp Images\\kaniazoom.jpg", imgZoom)
plt.subplot(1, 2, 1)
plt.imshow(image)
